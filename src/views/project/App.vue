	...
	<div class='project'>
		<main class="main">
			<div class='button-box'>
				...
				<p>
					项目负责人：
					<input v-model="projectMan" type="text" placeholder="可不填">
				</p>
				<p>
					项目时间：
			...
			<div class='project-box'>
				<header class='myheader'>
					...
					<p class="ProjectDetail">项目负责人</p>
					<p class="ProjectDetail">阅览人数</p>
				...
				<div class='content-box'>
					...
					<div class='list listBox' v-for="(item,index) in projectList.list">
						<header class='header-list'>
							<router-link :to="{name:'articleMenu',params:{Projectid:item.Projectid}}">
							<li class="projectLi">
								<p class="ProjectDetail">{{item.projectName}}</p>
								<p class="ProjectDetail">{{item.projectMan}}</p>
								<p class="ProjectDetail">{{item.howmany}}</p>
